...
const routes = [
    {
        ...
        children: [
            {
                path: 'mail',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_mail_mail_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../mail/mail.module */ 5185)).then(m => m.MailPageModule)
            },
            {
                path: 'mail/:id',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_details_details_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../details/details.module */ 557)).then(m => m.DetailsPageModule)
            },
            {
                path: 'meet',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_meet_meet_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../meet/meet.module */ 2142)).then(m => m.MeetPageModule)
            },
            {
                path: '',
                redirectTo: 'mail',
